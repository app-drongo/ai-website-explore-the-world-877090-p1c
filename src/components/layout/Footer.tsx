...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Discover breathtaking destinations and create unforgettable memories with our expertly curated travel experiences. Join thousands of adventurers who trust us to make their dream trips a reality.',
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Visa Information', href: '/visas', editableId: 'link-footer-visas' },
