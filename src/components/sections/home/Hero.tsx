...
const DEFAULT_HERO = {
  ...
  title: 'Discover breathtaking journeys to',
  titleHighlight: 'France, Morocco, Spain & Egypt',
  description:
    "Experience the world's most captivating destinations with our expertly curated travel packages. From Parisian elegance to Moroccan mystique, Spanish passion to Egyptian wonders.",
  features: [
  ...
  secondaryCTA: 'Watch Destinations',
  ...
  imageAlt: 'Stunning travel destinations collage',
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          <div className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1.5 text-sm font-medium text-red-700">
