...
const DEFAULT_CONTACT = {
  ...
  mainTitleHighlight: 'Amazing Destinations?',
  mainDescription:
    'Let our travel experts help you plan the perfect adventure to France, Morocco, Spain, or Egypt. Contact us today for personalized travel recommendations.',
  formTitle: 'Start Planning Your Trip',
  formDescription:
    "Tell us about your dream destination and we'll create a customized travel experience just for you.",
  submitButton: 'Get Travel Quote',
  contactSectionTitle: 'Connect With Our Travel Experts',
  method1Title: 'Email Our Team',
  method1Description: 'Get detailed travel information',
  method1Contact: 'travel@exploretheworld.com',
  method2Title: 'Call Travel Hotline',
  method2Description: 'Speak with travel specialists',
  method2Contact: '+1 (555) EXPLORE',
  method3Title: 'Live Travel Chat',
  method3Description: 'Instant travel assistance',
  method3Contact: 'Available 24/7',
  officesSectionTitle: 'Travel Offices Worldwide',
  office1City: 'Paris, France',
  office1Address: '15 Avenue des Champs-Élysées',
  office1Timezone: 'CET (UTC+1)',
  office2City: 'Marrakech, Morocco',
  office2Address: 'Medina Quarter, Jemaa el-Fnaa',
  office2Timezone: 'WET (UTC+0)',
  office3City: 'Madrid, Spain',
  office3Address: 'Gran Vía 28, Centro',
  ...
  messageLabel: 'Travel Preferences & Questions *',
  messagePlaceholder:
    'Tell us about your ideal trip - budget, travel dates, interests, group size, accommodation preferences...',
} as const;
...
export default function Contact(props: ContactProps) {
  ...
  const destinations = [
    ...
    { value: 'france', label: '🇫🇷 France - Paris, Nice, Lyon' },
    { value: 'morocco', label: '🇲🇦 Morocco - Marrakech, Casablanca, Fez' },
    { value: 'spain', label: '🇪🇸 Spain - Madrid, Barcelona, Seville' },
    { value: 'egypt', label: '🇪🇬 Egypt - Cairo, Luxor, Alexandria' },
  ];

  return (
    <section
      id="contact"
      className="py-24 bg-gradient-to-b from-primary/5 via-accent/10 to-background"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <Badge
            variant="outline"
            className="mb-4 px-4 py-2 border-primary/20 bg-gradient-to-r from-primary/10 to-accent/10"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-primary/20 rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-primary/20 rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all resize-none"
              ...
              <div className="grid gap-4">
                {contactMethods.map((method, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className="border-primary/20 hover:border-primary/40 transition-all cursor-pointer group hover:shadow-lg bg-gradient-to-r from-background to-primary/5"
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          <div className="size-12 rounded-lg bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center group-hover:from-primary/30 group-hover:to-accent/30 transition-all">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {offices.map((office, index) => (
                  <div
                    key={index}
                    className="p-4 border border-primary/20 rounded-lg bg-gradient-to-r from-background to-primary/5 hover:to-primary/10 transition-all"
                  >
